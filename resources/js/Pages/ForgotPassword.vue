...
<template>
    ...
    <div class="flex justify-center items-center min-h-screen bg-[#b3cec9]">
        ...
        <div class="min-h-screen bg-[#b6cdce] flex items-center justify-center w-full">
            <div class="realtive z-10 bg-white p-10 rounded-lg shadow-xl border border-gray-100 w-full max-w-md ">
                <h1 class="text-3xl font-bold text-gray-900 text-center mb-10">Forgot Password</h1>
