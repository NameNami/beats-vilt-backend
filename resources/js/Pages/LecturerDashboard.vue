    ...
    <AppLayout>
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
              ...
              <svg class="w-3 h-3 mr-0.5 stroke-[2.5]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                {{ item.students }} Students
                    ...
                    <div class="mt-4 md:mt-0">
                        <button
                            ...
                            class="w-full md:w-auto bg-amber-600 hover:bg-amber-700 text-white font-semibold py-2.5 px-6 rounded-lg transition-colors focus:ring-4 focus:ring-amber-600/20 cursor-pointer"
                        >
                        ...
                        <button
                            v-else
                            disabled
                            class="w-full md:w-auto bg-slate-50 text-slate-500 font-medium py-2.5 px-6 rounded-lg border border-slate-200 cursor-not-allowed capitalize"
                        >
                            {{ item.status }}
                        </button>
                    </div>
