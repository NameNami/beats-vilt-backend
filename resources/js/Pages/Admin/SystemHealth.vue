            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden ">
                    ...
                    <div class="p-6 flex flex-col justify-between h-[calc(100%-60px)]">
                        ...
                        <div class="mt-6">
                            <button @click="downloadBackup" :disabled="isDownloading" class="w-full bg-slate-900 hover:bg-slate-800 text-white px-6 py-3 rounded-xl font-bold transition disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer">
                ...
                <div class="lg:col-span-2 bg-white rounded-2xl border border-rose-200 overflow-hidden ">
                    ...
                    <div class="p-6">
                        ...
                        <form @submit.prevent="submitRollover" class="bg-rose-50 p-6 rounded-xl border border-rose-100 space-y-5">
                            ...
                            <button type="submit" :disabled="form.processing || form.confirmation !== 'CONFIRM'" class="w-full bg-rose-600 hover:bg-rose-700 text-white px-6 py-3 rounded-xl font-bold transition disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer">
