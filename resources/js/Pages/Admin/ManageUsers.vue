    ...
    <AdminLayout>
        ...
        <div v-if="!isEditing" class="bg-orange-50/30 p-6 rounded-xl  border border-orange-100 flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-xs text-orange-600 mt-2 font-mono bg-orange-100/50 inline-block px-2 py-1 border border-orange-200 rounded">Format: Name, Email, Student_ID</p>
            </div>
